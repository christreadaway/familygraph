...
1. **Internal infrastructure only.** Family Graph exists to make Chris's other products (MissionIQ, ParentPoint, future) better. It is never sold or licensed. It runs at every institution that adopts the rest of the portfolio.
