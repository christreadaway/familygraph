...
const BUILTIN_PROFILES = [
  ...
  },
  {
    name: 'parish_donor',
    config: {
      description: 'A parish development office. Donor giving history attaches by Sanctus codes; resolver tolerates more variance because donor records are messier.',
